...
public class NurseryTest implements Runnable {
		private Thread t;
    ...
    public static void main(String[] args) {
        ...
        String training_data_files[] = {
                //"nursery_transformed.csv",
                "nursery_training_full.csv"
        };
        String test_data_files[] = {
                //"4.csv",
                "nursery_test_full.csv"
        };

        int num_runs = 5; //This starts a new run at a new random point or random population
        int training_iterations[] = {5, 10, 15, 20, 25, 30, 35, 40, 45, 50};
