...
public class OptimizationTest {
    ...
    public static void main(String[] args) {
        ...
        count_one_test_params.put("SA_initial_temperature",100.);
        count_one_test_params.put("SA_cooling_factor",.95);
        count_one_test_params.put("GA_population",100.);
        count_one_test_params.put("GA_mate_number",50.);
        count_one_test_params.put("GA_mutate_number",10.);
        ...
        //Four Peaks Test (somewhat designed to trick hill climbers)
        ...
        N = new int[] {10,50,100,150,200};
        iterations = new int[] {1000, 1000, 1000, 1000};
        for (int i = 0; i < algorithms.length; i++) {
            for (int j = 0; j < N.length; j++) {
				for (int l = 0; l < num_runs; l++) {
					new Analyze_Optimization_Test(
        ...
        tsp_test_params.put("GA_mate_number",150.);
        tsp_test_params.put("GA_mutate_number",20.);
        tsp_test_params.put("MIMIC_samples",200.);
        tsp_test_params.put("MIMIC_to_keep",100.);

        N = new int[] {10,20,30,40,50};
        iterations = new int[] {1000, 1000, 1000, 1000};
        for (int i = 0; i < algorithms.length; i++) {
            for (int j = 0; j < N.length; j++) {
				for (int l = 0; l < num_runs; l++) {
        ...
        //N-Queens Problem
        HashMap<String, Double> nqueens_test_params = new HashMap<>();
        nqueens_test_params.put("SA_initial_temperature",1E1);
        nqueens_test_params.put("SA_cooling_factor",.1);
        nqueens_test_params.put("GA_population",200.);
        nqueens_test_params.put("GA_mate_number",10.);
        nqueens_test_params.put("GA_mutate_number",10.);
        nqueens_test_params.put("MIMIC_samples",200.);
        nqueens_test_params.put("MIMIC_to_keep",10.);
